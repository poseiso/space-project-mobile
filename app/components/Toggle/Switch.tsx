...
function SwitchInput(props: SwitchInputProps) {
  ...
  return (
    <View style={[$inputOuter, { backgroundColor: offBackgroundColor || undefined}, $outerStyleOverride]}>
      <Animated.View
        style={[
          $themedSwitchInner,
          { backgroundColor: onBackgroundColor || undefined},
          $innerStyleOverride,
      ...
      <Animated.View
        style={[
          ...
          { backgroundColor: knobBackgroundColor || undefined },
        ]}
      />
    </View>
  )
